...
class atlantis_rect {
    public:
        ...
        atlantis_rect(size_t _x, size_t _y, size_t _w, size_t _h): x(_x), y(_y), w(_w), h(_h), colour(atlantis_colour(1,1,1)){;}
        atlantis_rect(size_t _w, size_t _h): x(0), y(0), w(_w), h(_h), colour(atlantis_colour(1,1,1)){;}
